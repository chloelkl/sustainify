...
const UserMain = () => {
    ...
    const renderSection = () => {
        switch (selectedSection) {
            ...
            case 'settings':
                return <UserSettings userId={1} />;
            case 'analytics':
                return <UserAnalytics userId={1} />;
            case 'chat':
                return <ChatWithFriends userId={1} />;
            default:
                return null;
        }
    };
    ...
    return (
        <div style={containerStyle}>
            ...
            >
                <img src="/src/assets/UserLogo.png" alt="User Logo" style={imageStyle} />
            </div>
            {selectedSection && (
                <div style={{ 
                    ...commonSectionContainerStyle, 
                    ...(selectedSection === 'profile' ? profileContainerStyle : {}),
                    ...(selectedSection === 'settings' ? settingsContainerStyle : {}),
                    ...(selectedSection === 'analytics' ? analyticsContainerStyle : {}),
                    ...(selectedSection === 'chat' ? chatContainerStyle : {}),
            ...
            {!selectedSection && (
                <div style={{ ...mainOptionsStyle, ...(showSectionTitles ? fadeInStyle : fadeOutStyle) }}>
                    <div onClick={() => handleSectionClick('profile')} style={topOptionStyle}>Edit Profile</div>
                    ...
                    <div onClick={() => handleSectionClick('chat')} style={leftOptionStyle}>Chat with Friends</div>
                </div>
            )}
...
const logoPositionStyles = {
    profile: { transform: 'translate(-515%, -50%)', width: '150px', height: '150px' },
    settings: { transform: 'translate(-50%, 175%)', width: '150px', height: '150px' },
    analytics: { transform: 'translate(410%, -50%)', width: '150px', height: '150px' },
    chat: { transform: 'translate(-50%, -275%)', width: '150px', height: '150px' },
};
